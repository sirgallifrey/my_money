defmodule MyMoney.UserAccounts do
  @moduledoc """
  ...
  alias MyMoney.UserAccounts.{User, UserToken, UserNotifier}
  ...
  See `MyMoney.UserAccounts.User.email_changeset/3` for a list of supported options.
  ...
  See `MyMoney.UserAccounts.User.password_changeset/3` for a list of supported options.
